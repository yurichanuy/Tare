  ...
  m.reply = async (pesan, options) => {
    const a = {
      contextInfo: {
        ...
        isForwarded: true,
        externalAdReply: {
          title: `© Kesya-bot V${settings.version}`,
          body: "🔴 simple WhatsApp bot by D O R I",
          mediaType: 1,
          thumbnailUrl: "https://i.ibb.co.com/pxtmQ1J/IMG-20240720-WA0079-2.jpg",
        },
        forwardedNewsletterMessageInfo: {
          newsletterJid: "120363252742621904@newsletter",
          serverMessageId: 127,
          newsletterName: "K E S Y A x D O R I",
        },
      },
    };
    try {
